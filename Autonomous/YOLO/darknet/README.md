This part of the repo is taken from the darknet. It has been modified and stripped down by SoRo but is mostly not our work. <br>
To compile, first make the following edits in the darknet folder: <br>
```
sed -i 's/OPENCV=0/OPENCV=1/' Makefile
sed -i 's/LIBSO=0/LIBSO=1/' Makefile
```
If GPU support is desired then also change (you can also reverse the 0s and 1s to remove GPU support): <br>
```
...
```
Then run `make` <br>
Don't forget to download the .weights file and put it in this folder before running. Link to this coming soon <br>
 <br>
Read below for information about darknet and yolo.
